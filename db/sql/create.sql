...
(
    MEMBER_TYPE_NUM INT AUTO_INCREMENT PRIMARY KEY,
...
(
    ...
    FOREIGN KEY (MEMBER_TYPE_NUM) REFERENCES MEMBER_TYPE(MEMBER_TYPE_NUM),
    FOREIGN KEY (CAR_NUM) REFERENCES CAR_INFO(CAR_NUM)
);
